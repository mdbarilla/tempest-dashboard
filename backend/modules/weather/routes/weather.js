...
/**
 * GET /api/weather/planting-guidance
 * Safe-to-plant, frost risk, warming trend (Tempest + NWS merged daily lows).
 */
router.get('/planting-guidance', async (req, res) => {
  try {
    const data = await plantingGuidance.getSnapshot();
    res.json({
      success: true,
      data,
    });
